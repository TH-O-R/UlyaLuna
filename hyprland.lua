...
local term = "kitty"
local alt-term = "alacritty"
local browser = "firefox"
local alt-browser = "chromium"
local files = "thunar"
...
hl.config({
    general = {
        ...
        col = {
            active_border = {
                colors = {color6, color3},
                angle = 80
            },
            incative_border = color0,
        },
...
hl.bind("CTRL + SHIFT + Return", hl.dsp.exec_cmd(alt-term))
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("st"))
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("pavucontrol"))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd(browser))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd(alt-browser))
...
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.window.resize({50, 0}))
hl.bind(mainMod .. " + SHIFT + K", hl.dsp.window.resize({0, -50}))
hl.bind(mainMod .. " + SHIFT + J", hl.dsp.window.resize({0, 50}))
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.window.resize({-50, 0}))
